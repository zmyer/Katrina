...
#ifndef KATRINA_DATAPACKAGE_H
#define KATRINA_DATAPACKAGE_H
    ...
    namespace base {
        ...
        public:
            ...
            ByteArray Serialize() {
                ...
                ByteArray head = SerializedHead(body.size());
                return head + body;
            }
        ...
        private:
            ...
            ByteArray SerializedHead(int32_t bodySize) {
                ByteArrayWriter headWriter;
                _length = sizeof(int32_t) + sizeof(_version);
